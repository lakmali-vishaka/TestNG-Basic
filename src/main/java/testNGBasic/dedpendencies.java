...
public class dedpendencies {
	
	WebDriver driver;
	
	/* hard dependency depend on one method 
	...
	@Test(dependsOnMethods="TC1_openUrl")
	...
	//hard dependency depend on two methods
	@Test(dependsOnMethods={"TC1_openUrl","TC2_Maximize"})
	...
	*/
	...
	// hard dependency depend on groups
	...
	//hard dependency depend on two methods
	@Test(dependsOnMethods={"Loginl","Home"})
